...
@Kelvin = Doctor.create(name: "Doctor Kelvin Ben", photo:"images/doctor-kelvin.jpg", specialty:"Heart Surgeon", age: 42, location_of_work: "Kenya",
...
@Abdullah = Doctor.create(name: "Doctor Abdullah Nganje", photo:"images/doctor-abdul.jpg", specialty:"Dermatology", age: 45, location_of_work: "Kenya",
...
@Mohammed = Doctor.create(name: "Doctor Mohammed El-Deeb", photo:"images/doctor-mo.jpg", specialty:"Pediatrics", age: 42, location_of_work: "Egypt",
...
@Abubakar = Doctor.create(name: "Doctor Abubakar Ummar", photo:"images/doctor-abu.jpg", specialty:"Radiology and Imaging", age: 40, location_of_work: "Ghana",
...
@R1 =  Reservation.create(title: "Heart Surgery", reservation_date: "2021-03-07", phone_number: 123456789, purpose: "purpose Heart Surgery", location: "Kenya", doctor_name: "Doctor Kelvin Ben", user_id: 1)
@R2 = Reservation.create(title: "Dermatology", reservation_date: "2021-03-07", phone_number: 123456789, purpose: "purpose Dermatology", location: "Kenya", doctor_name: "Doctor Abdullah Nganje", user_id: 1  )
@R3 = Reservation.create(title: "Pediatrics", reservation_date: "2021-03-07", phone_number: 123456789, purpose: "purpose Pediatrics", location: "Egypt", doctor_name: "Doctor Mohammed El-Deeb", user_id: 1)
@R4 = Reservation.create(title: "Radiology and Imaging", reservation_date: "2021-03-07", phone_number: 123456789, purpose: "purpose Radiology and Imaging", location: "Ghana", doctor_name: "Doctor Abubakar Ummar", user_id: 1)

DoctorsReservation.create(doctor_id: @Kelvin.id, reservation_id: @R1.id)
DoctorsReservation.create(doctor_id: @Abdullah.id, reservation_id: @R2.id)
DoctorsReservation.create(doctor_id: @Mohammed.id, reservation_id: @R3.id)
DoctorsReservation.create(doctor_id: @Abubakar.id, reservation_id: @R4.id)